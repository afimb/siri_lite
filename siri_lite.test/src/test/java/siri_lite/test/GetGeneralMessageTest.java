...
@NoArgsConstructor
public class GetGeneralMessageTest extends AbstractUnit {

	private GeneralMessageRequestStructure request;
	public WsServiceRequestInfoStructure serviceRequestInfo;
	...
	public class Server {
		...
		public void getGeneralMessage(
			...
			GetGeneralMessageTest.this.serviceRequestInfo = serviceRequestInfo;
			GetGeneralMessageTest.this.request = request;
